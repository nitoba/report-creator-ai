...
template_instructions = dedent("""
    Use os dados fornecidos pelo usuário para escrever um relatório semanal.
        ...
        A resposta esperada é um relatório semanal detalhado que seja escrito com sucesso.
        """)
